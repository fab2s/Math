...
class MathTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_base_convert(string|int|Math $number, string $base)
    {
        ...
        if ($base > 62 && ! Math::gmpSupport()) {
            $this->markTestSkipped('Cannot test Base Conversion with bases 63 and 64 without ext-gmp');
    ...
    public function test_to_string()
    {
        ...
        $this->assertSame('33.33', (string) Math::number('33.33')->jsonSerialize());
    }
}
